...
async def async_alchemy_example(
    ...
    source_image_file_path: str = "examples/dog_in_a_hat.webp",
) -> None:
        ...
        status_response, job_id = await simple_client.alchemy_request(
            AlchemyAsyncRequest(
                ...
                forms=[
                    ...
                    AlchemyAsyncRequestFormItem(name=KNOWN_ALCHEMY_TYPES.RealESRGAN_x4plus),
                    AlchemyAsyncRequestFormItem(name=KNOWN_ALCHEMY_TYPES.GFPGAN),
                ],
